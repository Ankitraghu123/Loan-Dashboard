...
import { addSalesExecutive } from 'features/SalesExecutive/SalesExecutiveSlice';
...
const AddSalesExecutive = () => {
    ...
    const formHandler = (e) => {
        ...
        // Dispatch the addSalesExecutive action with form data
        dispatch(addSalesExecutive(formData));
    };

    return (
        <Card flexDirection="column" w="100%" style={{marginTop:"80px"}} px="0px" overflowX={{ sm: 'scroll', lg: 'hidden' }}>
            <Card.Body>
                <h5 className="mb-4">Add Sales Executive</h5>
                <Box>
